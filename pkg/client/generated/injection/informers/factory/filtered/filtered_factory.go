...
import (
	...
	externalversions "github.com/triggermesh/function/pkg/client/generated/informers/externalversions"
	client "github.com/triggermesh/function/pkg/client/generated/injection/client"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/triggermesh/function/pkg/client/generated/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}

...
import (
	...
	v1alpha1 "github.com/triggermesh/function/pkg/apis/function/v1alpha1"
	internalclientset "github.com/triggermesh/function/pkg/client/generated/clientset/internalclientset"
	functionv1alpha1 "github.com/triggermesh/function/pkg/client/generated/listers/function/v1alpha1"
	zap "go.uber.org/zap"
...
// controller finalizing v1alpha1.Function if they want to process tombstoned resources
...
type ReadOnlyFinalizer interface {
	// ObserveFinalizeKind implements custom logic to observe the final state of v1alpha1.Function.
	// This method should not write to the API.
	ObserveFinalizeKind(ctx context.Context, o *v1alpha1.Function) reconciler.Event
}
...
type reconcilerImpl struct {
	...
	Lister functionv1alpha1.FunctionLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client internalclientset.Interface, lister functionv1alpha1.FunctionLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
